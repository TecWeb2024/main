...
INSERT INTO `prodotto` (`ID`, `nome`, `immagine1`, `immagine2`, `immagine3`, `immagine4`, `alt`, `categoria`, `keywords`, `prezzo`, `peso`, `dimensione`, `colore`, `volume`, `materialeUtilizzato`, `quantita` , `taglia` , `descrizione`, `tempoConsegna`, `marca`) VALUES
...
(7,'Dumbbell','images/dumbbell1.jpg','images/dumbbell2.jpg','images/dumbbell3.jpg','images/dumbbell4.jpg','Manubrio hexagonale da 5 kg per allenamenti di sollevamento pesi.',2,'Olympo Fitness, palestra, negozio palestra, dumbbell, techongym, peso libero,prodotto palestra, prodotto, pesi liberi , macchinari palestra, macchinari, nutrizione', 70, '10 kg', '15 cm x 5 cm', NULL, 'Acciaio', 30, '10', 'I manubri Technogym sono studiati per offrirti una sensazione di allenamento naturale e maggiore efficacia, grazie al controllo completo del movimento e al coinvolgimento di più muscoli.','Consegna in 3-5 giorni lavorativi',3),
(8, 'Bumper Plate', 'images/bumper1.jpg', 'images/bumper2.jpg', 'images/bumper3.jpg', 'images/bumper4.jpg', 'Piatto paracolpi da 10 kg per esercizi di sollevamento pesi olimpico.',2, 'Olympo Fitness, palestra, negozio palestra, Bumper Plate, techongym, peso libero,prodotto palestra, prodotto, pesi liberi , macchinari palestra, macchinari, nutrizione', 20, '15 kg', '25 cm x 10 cm x 5 cm', NULL, 'Acciaio', 20, '10', 'Realizzati in gomma completamente nera, questi dischi sono progettati per resistere a un uso intensivo e assicurare un ottimo assorbimento degli impatti e un buon rimbalzo. La texture opaca sui lati esterni dei dischi li rende meno vulnerabili ai graffi.''Consegna in 3-5 giorni lavorativi',3),
(9, 'Impact Whey Protein', 'images/prot1.jpg', 'images/prot2.jpg', 'images/prot3.jpg', 'images/prot4.jpg', 'Immagine di un contenitore di proteine per il recupero muscolare post-allenamento.' ,3, 'Olympo Fitness, palestra, negozio palestra, proteine, myprotein, integratori,prodotto palestra, prodotto, pesi liberi , macchinari palestra, macchinari, nutrizione', 80, '25 kg', '15 cm x 15 cm', NULL, '--', 50, '10', 'Siero di latte di prima qualità con ben 23 g di proteine per porzione, per garantirti le proteine di cui hai bisogno. E da dove viene questo siero di latte? Da mucche allevate al pascolo che producono il latte ed il formaggio che consumi quotidianamente -semplicemente filtrato ed atomizzato al fine di produrre sostanze nutritive completamente naturali.','Consegna in 3-5 giorni lavorativi',6),
(10, 'Clear Whey Isolate', 'images/isolate1.jpg', 'images/isolate2.jpg', 'images/isolate3.jpg', 'images/isolate4.jpg', 'Isolato di proteine Clear Whey al gusto di frutti di bosco per un opzione leggera.' ,3, 'Olympo Fitness, palestra, negozio palestra, proteine, myprotein, integratori,prodotto palestra, prodotto, pesi liberi , macchinari palestra, macchinari, nutrizione', 80, '25 kg', '15 cm x 15 cm', NULL, '--', 60, '10', 'Clear Whey Isolate non è uno shake proteico qualunque. A partire da pregiate proteine di siero del latte idrolizzate abbiamo ricavato un’alternativa leggera e rinfrescante, più simile a un succo che a un frullato proteico a base di latte.','Consegna in 3-5 giorni lavorativi',6),
(11, 'Brownie proteico', 'images/brownie1.jpg', 'images/brownie2.jpg', 'images/brownie3.jpg', 'images/brownie4.jpg', 'Brownie proteico al cioccolato e noci per una dolce ricompensa dopo allenamento.' ,3, 'Olympo Fitness, palestra, negozio palestra, proteine, myprotein, integratori ,prodotto palestra, prodotto, pesi liberi , macchinari palestra, macchinari, nutrizione', 80, '5 kg', '30 cm x 15 cm', NULL, '--', 60, '10', 'Con fino al 75% di zucchero in meno rispetto alle alternative standard dei supermercati, goditi uno spuntino pomeridiano senza rovinare tutti i progressi duramente guadagnati.','Consegna in 3-5 giorni lavorativi',6),
(12, 'Omega-3 Essenziale', 'images/omega1.jpg', 'images/omega2.jpg', 'images/omega3.jpg', 'images/omega4.jpg', 'Immagine di un contenitore di integratori di Omega-3 essenziali per supportare la salute cardiaca e il benessere generale."' ,3, 'Olympo Fitness, palestra, negozio palestra, vitamine, myprotein, integratori ,prodotto palestra, prodotto, pesi liberi , macchinari palestra, macchinari, nutrizione', 80, '5 kg', '30 cm x 15 cm', NULL, '--', 60, '10', 'Gli omega-3 sono acidi grassi essenziali che il corpo non produce da solo, per cui è necessario ottenerli dall alimentazione. Si trovano naturalmente nell olio di pesce, ciò significa che può essere difficile ottenerne una quantità sufficiente soltanto dall alimentazione.',6),
(13, 'Omega-3 Essenziale', 'images/omega1.jpg', 'images/omega2.jpg', 'images/omega3.jpg', 'images/omega4.jpg', 'Immagine di un contenitore di integratori di Omega-3 essenziali per supportare la salute cardiaca e il benessere generale."', 3, 'Olympo Fitness, palestra, negozio palestra, vitamine, myprotein, integratori ,prodotto palestra, prodotto, pesi liberi , macchinari palestra, macchinari, nutrizione', 80, '5 kg', '30 cm x 15 cm', NULL, '--', 60, '10', 'Gli omega-3 sono acidi grassi essenziali che il corpo non produce da solo, per cui è necessario ottenerli dall alimentazione. Si trovano naturalmente nell olio di pesce, ciò significa che può essere difficile ottenerne una quantità sufficiente soltanto dall alimentazione.', 6),
(14, 'Chest Press Delt-HM002A', 'images/chest1.jpg', 'images/chest2.jpg', 'images/chest3.jpg', 'images/chest4.jpg', 'Immagine di una macchina Chest Press per allenare i muscoli pettorali.', 4, 'Olympo Fitness, palestra, negozio palestra, chest press, petto, Baodelong ,prodotto palestra, prodotto, pesi liberi , macchinari palestra, macchinari, nutrizione', 80, '85 kg', '130 cm x 95 cm x 103 cm', NULL, '--', 60, '10', 'La chest press machine è una macchina isotonica concepita per eseguire il gesto multiarticolare di distensione del braccio con sovraccarico, utile soprattutto nel rinforzo del gran pettorale, ma che coinvolge anche il tricipite brachiale e il deltoide/spalla anteriore.', 4),
(15, 'Skillrow', 'images/vogatore1.jpg', 'images/vogatore2.jpg', 'images/vogatore3.jpg', 'images/vogatore4.jpg', 'Attrezzo Skillrow per simulare una esperienza di vogare a casa o in palestra', 4, 'Olympo Fitness, palestra, negozio palestra, vogatore, petto, TechnoGym, ,prodotto palestra, prodotto, pesi liberi , macchinari palestra, macchinari, nutrizione', 80, '85 kg', '130 cm x 95 cm x 103 cm', NULL, '--', 60, '10', 'Progettato insieme agli atleti, con Skillrow puoi migliorare sia resistenza cardiovascolare che potenza tramite allenamenti total body sempre vari disponibili sulla app, e con la sensazione di vogata più realistica.', 3),
(16, 'Elliptical', 'images/Elliptical1.jpg', 'images/Elliptical2.jpg', 'images/Elliptical3.jpg', 'images/Elliptical4.jpg', 'Macchina ellittica con resistenza regolabile per un allenamento cardio completo', 4, 'Olympo Fitness, palestra, negozio palestra, Elittica, gambe, TechnoGym, ,prodotto palestra, prodotto, pesi liberi , macchinari palestra, macchinari, nutrizione', 80, '85 kg', '130 cm x 95 cm x 103 cm', NULL, '--', 60, '10', 'Scopri il potere del tuo corpo con il movimento naturale e confortevole dall’impatto minimo sulle tue articolazioni.', 3),
