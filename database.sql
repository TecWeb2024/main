...
--modificare id 2 e 3 (pantaloni adidas e maglietta adidas perchè non consideriamo i sessi, mettere corde o altro) e manca un macchinario (id 16)
...
ALTER TABLE `prodotto`
  MODIFY `ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16; --modificare in 17 quando si fa la riga 16 della tabella prodotti
